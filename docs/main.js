...
var MainJS = function() {
	...
	window.document.addEventListener("DOMContentLoaded",function(event) {
		$global.console.log("" + model_constants_App.NAME + " Dom ready :: build: " + "2021-10-02 11:59:58" + " ");
		_gthis.init();
		_gthis.setupNav();
...
MainJS.prototype = {
	...
	,setupNav: function() {
		var _gthis = this;
		var btnCSS = window.document.getElementById("btn-css");
		var btnHTML = window.document.getElementById("btn-html");
		var btnJS = window.document.getElementById("btn-js");
		btnCSS.onclick = function() {
			_gthis.loadJson("data/css.json");
		};
		btnHTML.onclick = function() {
			_gthis.loadJson("data/html.json");
		};
	...
	,onChooseGood: function() {
		console.log("src/MainJS.hx:133:","good");
		this.nextQ();
	}
	,onChooseWrong: function() {
		console.log("src/MainJS.hx:138:","wrong");
		this.nextQ();
	}
	,onChooseSkip: function() {
		console.log("src/MainJS.hx:145:","skip");
		this.nextQ();
	}
	...
	,loadJson: function(url) {
		...
		req.onData = function(data) {
			try {
				...
				console.log("src/MainJS.hx:232:",e);
			}
		};
		req.onError = function(error) {
			console.log("src/MainJS.hx:236:","error: " + error);
		};
		req.onStatus = function(status) {
			console.log("src/MainJS.hx:239:","status: " + status);
		};
		req.request(false);
	}
};
