...
var MainJS = function() {
	...
	window.document.addEventListener("DOMContentLoaded",function(event) {
		$global.console.log("" + model_constants_App.NAME + " Dom ready :: build: " + "2021-10-01 18:30:04" + " ");
		_gthis.init();
		_gthis.setupQ();
		_gthis.setupNav();
...
MainJS.prototype = {
	...
	,init: function() {
		...
		this.btnCorrect.onclick = function() {
			console.log("src/MainJS.hx:68:","correct");
		};
		this.btnWrong.onclick = function() {
			console.log("src/MainJS.hx:71:","wrong");
		};
		this.btnNotsure.onclick = function() {
			console.log("src/MainJS.hx:74:","not sure");
		};
	}
	,collapseQ: function() {
		console.log("src/MainJS.hx:79:","collapseQ");
		this.bsCollapse.hide();
	}
	,openQ: function() {
		console.log("src/MainJS.hx:84:","openQ");
	...
	,_keyDown: function(e) {
		if(e.metaKey == true) {
			...
			case "ArrowDown":
				...
				break;
			case "ArrowLeft":
				console.log("src/MainJS.hx:103:","choose good");
				break;
			case "ArrowRight":
				console.log("src/MainJS.hx:105:","choose wrong");
				break;
			case "ArrowUp":
				this.collapseQ();
				break;
	...
	,setupQAndA: function() {
		...
		this.q.innerHTML = flashCard.question;
	...
	,loadJson: function(url) {
		...
		req.onData = function(data) {
			try {
				...
				console.log("src/MainJS.hx:162:",e);
			}
		};
		req.onError = function(error) {
			console.log("src/MainJS.hx:166:","error: " + error);
		};
		req.onStatus = function(status) {
			console.log("src/MainJS.hx:169:","status: " + status);
		};
		req.request(false);
	}
};
